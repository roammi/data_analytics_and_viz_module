...
-> con los atributos preatencionales y los tipos de datos: cómo combinamos ese conocimiento en construir una gráfica, veamos como algunas gráficas codifican diferentes tipos de datos:
[gráfica]
### tipos de variables en la Visualización
+-----+--------------+------------+-----+
|Datos|Tipos de datos|Codificación|Notas|
+-----+--------------+------------+-----+
|esto | Categórico   |Posición    |cada esto|
+-----+--------------+------------+-----+
