...
nombre, profesión, fundación?, pais de origen? arrestado en enero, 
...
[imagen de modric]
año de nacimiento, torneos jugados, ganados, mundiales,
delantero?, capitán
...
- como hay un número infinito de posibles valores intermedios
[marcelo martins] 
altura, pero cambia, peso, rentabilidad. monto de ventas
...
[mujer que se paró en SCZ]
fecha de nacimiento, altura, apareció N veces en el periódico, años que vive en SCZ.
cantidad de ventas
djokovic gana N copas, no n y medio

53 años
## Ejemplos, datos codificados en las Visualizaciones
- Visualización

### tipos de variables en la Visualización
...
Dependiendo el cono que les falta, las personas con DVC se les dificulta distiguir entre algunos colores debido a la forma en que ellos ven el espectro de colores:
8% de los hombres vs 0.4% de las mujeres
1 Protanopia, falta de conos de onda larga - débil en el rojo
2 Deuteranopia, falta de conos de onda media - débil en el verde
3 Tritanopia, falta de conos de onda corta - azul muy raro.

*rojo y verde ! evitar semáforos
...
## Tarea 2
Descargar el archivo Excel, completarlo y enviar.
