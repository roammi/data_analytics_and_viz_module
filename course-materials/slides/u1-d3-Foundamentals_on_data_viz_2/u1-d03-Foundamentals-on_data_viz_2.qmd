...
- Se quiere mostrar el valor de la medida en una forma que sea interpretada lo más preciso en el menor tiempo posible.
[ejemplos]

## Algunos problemas con atributos preatencionales 
Mezclando posición, color y forma no lo hace fácil leer.
¿Hay alternativa?
+-------+--------+-------+
|       |   2007 |  2008 |
+-------+--------+-------+
...
## ejemplos 2 profundidar del mar
